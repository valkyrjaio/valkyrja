...
final class ResponseSentMiddlewareStoppedFixture implements ResponseSentMiddlewareContract
{
    ...
    public function responseSent(ServiceCallContract $call, ServiceResponseContract $response, ResponseSentHandlerContract $handler): void
    {
        ...
        // Deliberately does not delegate, to short-circuit the remainder of the chain.
    }
}
