 ...
 */
final class CastableModelFixture extends CastableModel
{
    ...
    public ModelFixture $model;
    /** @var ModelFixture[] */
    public array $modelArray;

    public EnumFixture $enum;
    /** @var EnumFixture[] */
    ...
    public static function getCastings(): array
    {
        return [
            ...
            self::MODEL_PROPERTY                   => new OriginalCast(ModelFixture::class),
            self::MODEL_ARRAY_PROPERTY             => new OriginalArrayCast(ModelFixture::class),
            self::ENUM_PROPERTY                    => new OriginalCast(EnumFixture::class),
            self::ENUM_ARRAY_PROPERTY              => new OriginalArrayCast(EnumFixture::class),
