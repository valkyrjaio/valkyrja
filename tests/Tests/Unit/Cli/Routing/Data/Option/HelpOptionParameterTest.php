...
final class HelpOptionParameterTest extends TestCase
{
    ...
    {
        $option = new HelpOptionParameter();

        self::assertSame('help', $option->getName());
        self::assertSame('Help with this command', $option->getDescription());
        self::assertSame(['h'], $option->getShortNames());
