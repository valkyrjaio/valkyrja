...
final class PdoStatementTest extends TestCase
{
    ...
    public function testGetColumnMetaThrowsExceptionOnFailure(): void
    {
        ...
        $this->expectException(OrmInvalidColumnNumberException::class);
    ...
    public function testFetchThrowsExceptionOnFailure(): void
    {
        ...
        $this->expectException(OrmFetchException::class);
    ...
    public function testGetCountThrowsExceptionForUnsupportedType(): void
    {
        ...
        $this->expectException(OrmUnsupportedCountException::class);
