...
final class OrNotWhereGroupTest extends TestCase
{
    public function testExtendsWhereGroup(): void
    {
        $whereGroup = new OrNotWhereGroup();
    ...
    public function testPreservesWhere(): void
    {
        ...
        $whereGroup = new OrNotWhereGroup($where1, $where2);
    ...
    public function testToStringWithEmptyGroup(): void
    {
        ...
        self::assertSame('OR NOT ()', (string) $whereGroup);
    }

    public function testToStringWithSingleWhere(): void
    {
        $whereGroup = new OrNotWhereGroup(new Where(new Value('status', 'active')));

        self::assertSame('OR NOT (status = :status)', (string) $whereGroup);
    }
    ...
    public function testToStringWithMultipleWhere(): void
    {
        ...
        self::assertSame('OR NOT (title LIKE :title AND body LIKE :body)', (string) $whereGroup);
    }

    public function testReadonlyClass(): void
    {
        $reflection = new ReflectionClass(OrNotWhereGroup::class);
