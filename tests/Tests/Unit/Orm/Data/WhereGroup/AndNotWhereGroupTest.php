...
final class AndNotWhereGroupTest extends TestCase
{
    public function testExtendsWhereGroup(): void
    {
        $whereGroup = new AndNotWhereGroup();
    ...
    public function testPreservesWhere(): void
    {
        ...
        $whereGroup = new AndNotWhereGroup($where1, $where2);
    ...
    public function testToStringWithEmptyGroup(): void
    {
        ...
        self::assertSame('AND NOT ()', (string) $whereGroup);
    }

    public function testToStringWithSingleWhere(): void
    {
        $whereGroup = new AndNotWhereGroup(new Where(new Value('status', 'active')));

        self::assertSame('AND NOT (status = :status)', (string) $whereGroup);
    }
    ...
    public function testToStringWithMultipleWhere(): void
    {
        ...
        self::assertSame('AND NOT (title LIKE :title OR body LIKE :body)', (string) $whereGroup);
    }

    public function testReadonlyClass(): void
    {
        $reflection = new ReflectionClass(AndNotWhereGroup::class);
