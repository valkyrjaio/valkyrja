...
use Valkyrja\Orm\Data\Where\OrNotWhere;
use Valkyrja\Orm\Enum\Comparison;
use Valkyrja\Orm\Enum\WhereType;
use Valkyrja\Tests\Unit\Abstract\TestCase;

final class OrNotWhereTest extends TestCase
{
    ...
    public function testHasOrNotType(): void
    {
        $value = new Value('column', 'test');
        $where = new OrNotWhere($value);

        self::assertSame(WhereType::OR_NOT, $where->type);
    }
