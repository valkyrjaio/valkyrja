...
final class ComponentProviderTest extends TestCase
{
    public function testGetComponentProviders(): void
    {
        ...
        self::assertEmpty(ApiComponentProvider::getComponentProviders($app));
    }
    ...
    public function testGetEventProviders(): void
    {
        ...
        self::assertEmpty(ApiComponentProvider::getEventProviders($app));
    }
    ...
    public function testGetCliProviders(): void
    {
        ...
        self::assertEmpty(ApiComponentProvider::getCliProviders($app));
    }
    ...
    public function testGetHttpProviders(): void
    {
        ...
        self::assertEmpty(ApiComponentProvider::getHttpProviders($app));
    }
}
