...
final class ResponseFactoryTest extends TestCase
{
    public function testCreateResponse(): void
    {
        ...
        self::assertSame('foo', $response->getHeaders()->getHeaderLine('test'));
    }
    ...
    public function testCreateTextResponse(): void
    {
        ...
        self::assertSame('', $default->getBody()->getContents());
        self::assertSame(StatusCode::OK, $default->getStatusCode());
        self::assertSame('text/plain; charset=utf-8', $default->getHeaders()->getHeaderLine(HeaderName::CONTENT_TYPE));

        self::assertSame($content, $response->getBody()->getContents());
        self::assertSame($statusCode, $response->getStatusCode());
        self::assertSame('foo', $response->getHeaders()->getHeaderLine('test'));
        self::assertSame('text/plain; charset=utf-8', $response->getHeaders()->getHeaderLine(HeaderName::CONTENT_TYPE));
    }
    ...
    public function testCreateJsonResponse(): void
    {
        ...
        self::assertSame('[]', $default->getBody()->getContents());
        self::assertSame(StatusCode::OK, $default->getStatusCode());
        self::assertSame(ContentTypeValue::APPLICATION_JSON, $default->getHeaders()->getHeaderLine(HeaderName::CONTENT_TYPE));

        self::assertSame(json_encode($data, JSON_THROW_ON_ERROR), $response->getBody()->getContents());
        self::assertSame($statusCode, $response->getStatusCode());
        self::assertSame('foo', $response->getHeaders()->getHeaderLine('test'));
        self::assertSame(ContentTypeValue::APPLICATION_JSON, $response->getHeaders()->getHeaderLine(HeaderName::CONTENT_TYPE));
    }
    ...
    public function testCreateJsonpResponse(): void
    {
        ...
        self::assertSame(StatusCode::OK, $default->getStatusCode());
        self::assertSame(ContentTypeValue::TEXT_JAVASCRIPT, $default->getHeaders()->getHeaderLine(HeaderName::CONTENT_TYPE));

        self::assertSame('/**/callbackMethod({"test":"bar"});', $response->getBody()->getContents());
        self::assertSame($statusCode, $response->getStatusCode());
        self::assertSame('foo', $response->getHeaders()->getHeaderLine('test'));
        self::assertSame(ContentTypeValue::TEXT_JAVASCRIPT, $response->getHeaders()->getHeaderLine(HeaderName::CONTENT_TYPE));
    }
    ...
    public function testCreateRedirectResponse(): void
    {
        ...
        self::assertSame('/', $default->getHeaders()->getHeaderLine(HeaderName::LOCATION));

        self::assertSame($statusCode, $response->getStatusCode());
        self::assertSame('foo', $response->getHeaders()->getHeaderLine('test'));
        self::assertSame($uri, $response->getHeaders()->getHeaderLine(HeaderName::LOCATION));
    }
}
