...
class VersionCommandTest extends TestCase
{
    public function testRun(): void
    {
        ...
        self::assertSame(ApplicationContract::ASCII, $output->getMessages()[0]->getText());
        ...
        self::assertSame(ApplicationContract::VERSION, $output->getMessages()[5]->getText());
        self::assertSame(' (built: ', $output->getMessages()[6]->getText());
        self::assertSame(ApplicationContract::VERSION_BUILD_DATE_TIME, $output->getMessages()[7]->getText());
