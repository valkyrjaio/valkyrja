...
class ApplicationTest extends TestCase
{
    ...
    public function testEnsureDefaultComponents(): void
    {
        ...
        self::assertTrue($container->has(CommandMatchedHandlerContract::class));
        self::assertTrue($container->has(CommandNotMatchedHandlerContract::class));
        self::assertTrue($container->has(CommandDispatchedHandlerContract::class));
