...
use Valkyrja\Cli\Middleware\Handler\Contract\ExitedHandlerContract as CliExitedHandlerContract;
use Valkyrja\Cli\Middleware\Handler\Contract\InputReceivedHandlerContract as CliInputReceivedHandlerContract;
...
use Valkyrja\Http\Middleware\Handler\Contract\RequestReceivedHandlerContract as HttpRequestReceivedHandlerContract;
...
use Valkyrja\Http\Middleware\Handler\Contract\SendingResponseHandlerContract as HttpSendingResponseHandlerContract;
use Valkyrja\Http\Middleware\Handler\Contract\TerminatedHandlerContract as HttpTerminatedHandlerContract;
...
class ApplicationTest extends TestCase
{
    ...
    public function testEnsureDefaultComponents(): void
    {
        ...
        self::assertTrue($container->has(CliInputReceivedHandlerContract::class));
        ...
        self::assertTrue($container->has(CliExitedHandlerContract::class));
        ...
        self::assertTrue($container->has(HttpRequestReceivedHandlerContract::class));
        ...
        self::assertTrue($container->has(HttpSendingResponseHandlerContract::class));
        self::assertTrue($container->has(HttpTerminatedHandlerContract::class));
