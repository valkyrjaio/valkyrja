...
class ServiceProviderTest extends ServiceProviderTestCase
{
    ...
    {
        $this->container->setSingleton(SessionAuthenticator::class, $this->createMock(SessionAuthenticator::class));
    ...
    public function testPublishEncryptedJwtAuthenticator(): void
    {
        ...
        $this->container->setSingleton(Jwt::class, $this->createMock(Jwt::class));
        $this->container->setSingleton(ServerRequest::class, $this->createMock(ServerRequest::class));
        $this->container->setSingleton(Store::class, $this->createMock(Store::class));
        $this->container->setSingleton(PasswordHasher::class, $this->createMock(PasswordHasher::class));
    ...
    {
        $this->container->setSingleton(Session::class, $this->createMock(Session::class));
        $this->container->setSingleton(Store::class, $this->createMock(Store::class));
        $this->container->setSingleton(PasswordHasher::class, $this->createMock(PasswordHasher::class));
    ...
    {
        $this->container->setSingleton(OrmStore::class, $this->createMock(OrmStore::class));
    ...
    {
        $this->container->setSingleton(Manager::class, $this->createMock(Manager::class));
