...
use Valkyrja\Support\Type\Exceptions\InvalidVlidShortException;

/**
 * Class VlidS.
 *
 * Valkyrja Universally Unique Lexicographically Sortable Identifier - Short (VLID-S)
 ...
 */
class VlidS extends Vlid
{
    public const REGEX = '[0-7][' . self::VALID_CHARACTERS . ']{20}';

    protected const MAX_RANDOM_BYTES = 2;

    protected const FORMAT = '%013s%04s%04s';
    ...
    {
        throw new InvalidVlidShortException("Invalid VLID-T $uid provided.");
    }
}
