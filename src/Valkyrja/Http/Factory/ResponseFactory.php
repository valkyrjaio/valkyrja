...
namespace Valkyrja\Http\Factory;

use InvalidArgumentException;
use JsonException;
use Valkyrja\Container\Contract\Container;
use Valkyrja\Http\Factory\Contract\ResponseFactory as Contract;
...
class ResponseFactory implements Contract
{
    ...
    public function createResponse(
        ...
        return \Valkyrja\Http\Response\Response::create(
            content: $content,
    ...
    public function createJsonResponse(
        ...
        return \Valkyrja\Http\Response\JsonResponse::createFromData(
            data: $data,
            statusCode: $statusCode,
            headers: $headers
        );
    ...
    public function createRedirectResponse(
        ...
        return \Valkyrja\Http\Response\RedirectResponse::createFromUri(
            uri: $uri,
            statusCode: $statusCode,
            headers: $headers
        );
