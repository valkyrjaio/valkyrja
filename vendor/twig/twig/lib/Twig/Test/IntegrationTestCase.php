 ...
 */
abstract class Twig_Test_IntegrationTestCase extends PHPUnit_Valkyrja_TestCase
{
    /**
     * @return string
     */
        ...
        foreach ($outputs as $i => $match) {
            ...
            try {
                ...
                if (false !== $exception) {
                    ...
                    $this->assertSame(
                        '.',
                        substr($message, strlen($message) - 1),
                        $message,
                        'Exception message must end with a dot.'
                    );
            ...
            if (false !== $exception) {
                ...
                $this->assertThat(null, new PHPUnit_Valkyrja_Constraint_Exception($class));
            }
