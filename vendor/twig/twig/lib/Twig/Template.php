...
abstract class Twig_Template implements Twig_TemplateInterface
{
    ...
    {
        @trigger_error(
            'The ' . __METHOD__ . ' method is deprecated since version 1.20 and will be removed in 2.0.',
            E_USER_DEPRECATED
        );
    ...
    )
    {
        ...
        if (self::METHOD_CALL !== $type) {
            ...
            if ((is_array($object) && array_key_exists(
                        $arrayItem,
                        $object
        ...
        elseif (isset(self::$cache[$class]['methods']['__call'])) {
            ...
            throw new Twig_Error_Runtime(
                sprintf(
                    'Neither the property "%1$s" nor one of the methods "%1$s()", "get%1$s()"/"is%1$s()" or "__call()" exist and have public access in class "%2$s"',
                    $item,
                    get_class($object)
                ), -1, $this->getTemplateName()
            );
        }
