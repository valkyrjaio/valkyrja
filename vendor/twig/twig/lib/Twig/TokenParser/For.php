...
class Twig_TokenParser_For extends Twig_TokenParser
{
    ...
    {
        if ($node instanceof Twig_Node_Expression_GetAttr && $node->getNode(
                'node'
    ...
    protected function checkLoopUsageBody(Twig_TokenStream $stream, Twig_NodeInterface $node)
    {
        if ($node instanceof Twig_Node_Expression_GetAttr && $node->getNode(
            ...
            if ($attribute instanceof Twig_Node_Expression_Constant && in_array(
                ...
                throw new Twig_Error_Syntax(
                    sprintf(
                        'The "loop.%s" variable is not defined when looping with a condition.',
                        $attribute->getAttribute('value')
                    ), $node->getLine(), $stream->getFilename()
                );
            }
        }
