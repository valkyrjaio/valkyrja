...
class Twig_Tests_Node_ModuleTest extends Twig_Test_NodeTestCase
{
    public function testConstructor()
    {
        ...
        $filename = 'foo.twig';
        $node = new Twig_Node_Module($body, $parent, $blocks, $macros, $traits, new Twig_Node([]), $filename);
    ...
    public function getTests()
    {
        ...
        $node = new Twig_Node_Module($body, $extends, $blocks, $macros, $traits, new Twig_Node([]), $filename);
        $tests[] = [
            $node,
            <<<EOF
           <?php
...
EOF,
        ...
        $import = new Twig_Node_Import(
            new Twig_Node_Expression_Constant('foo.twig', 1),
            new Twig_Node_Expression_AssignName('macro', 1),
            2
        );
...
EOF,
        ...
        $set = new Twig_Node_Set(
            false,
            new Twig_Node([new Twig_Node_Expression_AssignName('foo', 4)]),
            new Twig_Node([new Twig_Node_Expression_Constant('foo', 4)]),
            4
        );
