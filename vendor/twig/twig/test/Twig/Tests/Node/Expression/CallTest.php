...
class Twig_Tests_Node_Expression_CallTest extends PHPUnit_Valkyrja_TestCase
{
    ...
    public function testResolveArgumentsWithMissingValueForOptionalArgument()
    {
        if (defined('HHVM_VERSION')) {
            $this->markTestSkipped(
                'Skip under HHVM as the behavior is not the same as plain PHP (which is an edge case anyway)'
            );
        }
    ...
    /**
     * @expectedException              LogicException
     * @expectedExceptionMessageRegExp #^The last parameter of "custom_Twig_Tests_Node_Expression_CallTest_function"
     *                                 for function "foo" must be an array with default value, eg\. "array \$arg \=
     *                                 array\(\)"\.$#
     */
    ...
    /**
     * @expectedException              LogicException
     * @expectedExceptionMessageRegExp #^The last parameter of "CallableTestClass\:\:__invoke" for function "foo" must
     *                                 be an array with default value, eg\. "array \$arg \= array\(\)"\.$#
     */
