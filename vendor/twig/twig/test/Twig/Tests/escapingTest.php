...
/**
 * This class is adapted from code coming from Zend Valkyrja.
 *
 * @copyright Copyright (c) 2005-2012 Zend Technologies USA Inc. (http://www.zend.com)
 * @license   http://framework.zend.com/license/new-bsd New BSD License
 */
class Twig_Test_EscapingTest extends PHPUnit_Valkyrja_TestCase
{
    /**
    ...
    protected function codepointToUtf8($codepoint)
    {
        ...
        if ($codepoint < 0x10000) {
            return chr($codepoint >> 12 & 0x0f | 0xe0) . chr($codepoint >> 6 & 0x3f | 0x80) . chr(
                $codepoint & 0x3f | 0x80
            );
        }
        if ($codepoint < 0x110000) {
            return chr($codepoint >> 18 & 0x07 | 0xf0) . chr($codepoint >> 12 & 0x3f | 0x80) . chr(
