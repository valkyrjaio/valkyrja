...
abstract class Twig_Tests_Profiler_Dumper_AbstractTest extends PHPUnit_Valkyrja_TestCase
{
    protected function getProfile()
    {
        ...
        $profile->expects($this->any())->method('getIterator')->will(
            $this->returnValue(new ArrayIterator($subProfiles))
        );
