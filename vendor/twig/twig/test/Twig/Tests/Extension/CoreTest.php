...
class Twig_Tests_Extension_CoreTest extends PHPUnit_Valkyrja_TestCase
{
    /**
    ...
    public function testRandomFunction($value, $expectedInArray)
    {
        ...
        for ($i = 0; $i < 100; ++$i) {
            $this->assertTrue(
                in_array(twig_random($env, $value), $expectedInArray, true)
    ...
    public function testRandomFunctionOnNonUTF8String()
    {
        ...
        for ($i = 0; $i < 30; ++$i) {
            ...
            $this->assertTrue(
                in_array(
                    twig_convert_encoding($rand, 'UTF-8', 'ISO-8859-1'),
                    [
                        'Ä',
                        'é',
                    ],
