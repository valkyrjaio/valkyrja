...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Valkyrja_TestCase
{
    /**
    ...
    public function testPaths($basePath)
    {
        ...
        $this->assertEquals(
            str_replace('\\', '/', $basePath . '/named_quater/named_absolute.html'),
            str_replace('\\', '/', $loader->getCacheKey('@named/named_absolute.html'))
        );
